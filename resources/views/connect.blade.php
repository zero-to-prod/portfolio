<x-main>
    @if(session()->has('email'))
        <div id="toast" aria-live="assertive"
             class="z-50 opacity-0 transition duration-500 pointer-events-none fixed inset-0 flex items-end px-4 py-6 sm:items-start sm:p-6">
                    ...
                    <div class="p-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 w-0 flex-1 pt-0.5">
                                ...
                                <p class="mt-1 text-sm text-gray-500">You will be contacted via email
                                    at: {{session()->get('email')}}</p>
                            </div>
    ...
    <div class="bg-gradient-to-b from-sky-200 to-white sm:py-6 sm:py-12">
        <div class="sm:bg-white sm:shadow sm:rounded-lg px-6 lg:px-8 max-w-xl mx-auto py-8">
            ...
            <form action="{{route(Routes::connect_store->name)}}" method="post" class="mx-auto mt-8">
                @csrf
