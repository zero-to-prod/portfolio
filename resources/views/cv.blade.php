        ...
        <ol aria-label="Work History List" role="list" class="overflow-hidden">
            ...
            <li class="relative pb-10">
                ...
                <div class="relative flex items-start group">
                  <span class="m-2 flex items-center shadow-lg">
                    ...
                    <div class="mt-3 ml-4 flex min-w-0 flex-col">
                        <span class="font-medium">Full Stack Developer</span> <span class="text-gray-800">ViewRail Full-time </span>
                ...
                <div class="relative flex items-start group">
                  <span class="m-2 flex items-center shadow-lg">
                    ...
                    <div class="mt-3 ml-4 flex min-w-0 flex-col">
                        ...
                        <details open class="text-gray-800">
                            <summary class="cursor-pointer py-2 font-medium">Click to hide details</summary>
            ...
            <li class="relative pb-10">
                ...
                <div class="relative flex items-start group">
                  ...
                  </span> <span class="mt-3 ml-4 flex min-w-0 flex-col">
                  ...
                  <span class="m-2 flex items-center shadow-lg">
                    <span class="relative z-10 flex h-20 w-20 items-center justify-center">
                      <img src="{{ Vite::asset('resources/images/generic-logo.jpg') }}" alt="zero to prod logo"/>
                        ...
                        <span class="font-medium">Full Stack Developer / Owner</span>
                  ...
                  <span class="m-2 flex items-center shadow-lg">
                    <span class="relative z-10 flex h-20 w-20 items-center justify-center">
                      <img src="{{ Vite::asset('resources/images/generic-logo.jpg') }}"
                        ...
                        <span class="font-medium">Design Engineer / Machinist</span>
