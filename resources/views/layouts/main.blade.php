                ...
                <form action="{{route_as(Routes::search)}}" method="post">
                    ...
                    <div class="flex rounded-md ">
                        <div class="relative flex flex-grow focus-within:z-10">
                            <input class="h-[40px] appearance-none block w-full rounded-none rounded-l-md border-0 py-1.5 pl-4 text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6"
                                   name="{{$search}}"
                                   id="{{$search}}"
